...
class ClipboardManager {
    ...
    private func checkForChanges() {
        ...
        // Skip concealed/transient content (passwords from password managers,
        // auto-generated entries) per http://nspasteboard.org conventions
        let skipTypes: Set<String> = [
            "org.nspasteboard.ConcealedType",
            "org.nspasteboard.TransientType",
            "org.nspasteboard.AutoGeneratedType"
        ]
        if pb.types?.contains(where: { skipTypes.contains($0.rawValue) }) == true { return }
